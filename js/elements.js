// Element creation and manipulation for Page Builder

import { uid, findElementInArray, getBufferLayer, cloneElements } from './state.js';

export function updateBoxColumns(box) {
...
export function createCanvas(name, w, h, category, isMain) {
    const defaultLayer = {
        id: uid(),
        name: 'Layer 1',
        elements: [],
...
export function showCanvasInBuffer(targetCanvas, sourceCanvas, renderAll, pushHistory) {
...
export function handleButtonAction(el, state, findElement, getParentCanvas, findElementInArray, renderAll, pushHistory) {
    ...
    switch (action) {
        ...
        case 'page': {
            ...
            if (!sourceCanvas) return;
            showCanvasInBuffer(targetCanvas, sourceCanvas, renderAll, pushHistory);
            break;
        }
        case 'dynamic': {
