// ============================================================
// RENDERERS - Canvas, elements, panels, properties, assets
// ============================================================
...
(function() {
    ...
    const {
        ...
        getParentElement, getElementContainer, getContainingLayer,
        getBufferLayer, FONT_LIST
    } = core;

    const {
        removeElement, bringToFront, sendToBack, bringForward, sendBackward,
        selectElement, createElement, updateBoxColumns, pushHistory,
        handleAssetDrop, handleButtonAction
    } = actions;
    ...
    function renderCanvases() {
        ...
        for (const canvas of state.canvases) {
            ...
            actionsDiv.append(bgColorInput, delBtn);

            header.append(nameInput, cres, actionsDiv);
    ...
    window.PB.renderers = {
        ...
        applyZoomPan,
        updateToolbarState,
        showContextMenu: function(x, y, canvasId, elementId) {
            // Will be overwritten by UI module
            if (window.PB.ui && window.PB.ui.showContextMenu) {
                window.PB.ui.showContextMenu(x, y, canvasId, elementId);
            } else {
                console.warn('UI module not loaded');
            }
        },
        openLightbox: function(src) {
            if (window.PB.ui && window.PB.ui.openLightbox) {
                window.PB.ui.openLightbox(src);
            }
        },
    };
})();